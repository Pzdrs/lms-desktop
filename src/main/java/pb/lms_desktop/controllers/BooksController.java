...
public class BooksController implements Initializable {
    ...
    public void create() {
        ...
        result.ifPresent(book -> {
            try {
                CloseableHttpResponse response = Main.getApi().post("/books",
    ...
    public void delete(Book book) {
        if (Utils.createConfirmationAlert("Are you sure you want to delete this book?")) {
            try {
                Main.getApi().delete("/books/" + book.getId()).close();
        ...
        result.ifPresent(newBook -> {
            try {
                Main.getApi().patch("/books/" + book.getId(),
                        ...
                        new BasicNameValuePair("author", newBook.getAuthor().getId())).close();
